...
"[project]/.next-internal/server/app/api/household/care/doses/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/household/care/doses/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
async function GET() {
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$household$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getHouseholdStore"])().doses);
}
async function POST(request) {
    ...
    if (action === "log") {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(newDose, {
            status: 201
        });
    }
    if (action === "snooze") {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$household$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setHouseholdStore"])(store);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(dose, {
            status: 201
        });
    }
    if (action === "skip") {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__038ed3e3._.js.map