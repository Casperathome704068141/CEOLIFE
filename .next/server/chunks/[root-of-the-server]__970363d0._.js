...
"[project]/.next-internal/server/app/api/onboarding/detect/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/lib/onboarding/serverState.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s({
    ...
    "getServerSetup": (()=>getServerSetup),
    "markStep": (()=>markStep),
    "mergeSetup": (()=>mergeSetup),
    "setServerSetup": (()=>setServerSetup)
});
...
function getServerSetup() {
    ...
    return globalThis.__ONBOARDING_STATE__;
}
function setServerSetup(next) {
...
function computeProgress(steps) {
    const total = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$onboarding$2f$validators$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["StepOrder"].length;
    const completed = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$onboarding$2f$validators$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["StepOrder"].filter((step)=>steps[step]).length;
    return Math.round(completed / total * 100);
}
function mergeSetup(partial) {
    const current = getServerSetup();
    const merged = {
        ...current,
        ...partial,
...
"[project]/src/app/api/onboarding/detect/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$onboarding$2f$serverState$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/onboarding/serverState.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$onboarding$2f$validators$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/onboarding/validators.ts [app-route] (ecmascript)");
;
;
;
function determineMissing(setup) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$onboarding$2f$validators$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["StepOrder"].filter((step)=>!setup.steps[step]);
}
function buildProgressByStep(setup) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$onboarding$2f$validators$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["StepOrder"].reduce((acc, step)=>{
...
async function POST(req) {
    ...
    const incoming = body?.setup;
    const setup = incoming ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$onboarding$2f$serverState$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["mergeSetup"])(incoming) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$onboarding$2f$serverState$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getServerSetup"])();
    const response = {
        missing: determineMissing(setup),
        progressByStep: buildProgressByStep(setup),
        setup: {
            ...setup,
            progress: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$onboarding$2f$serverState$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["computeProgress"])(setup.steps)
        }
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__970363d0._.js.map