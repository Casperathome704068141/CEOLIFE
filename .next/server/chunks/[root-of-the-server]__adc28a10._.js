...
"[project]/.next-internal/server/app/api/household/care/appointments/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/household/care/appointments/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
async function GET() {
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$household$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getHouseholdStore"])().appointments);
}
async function POST(request) {
    ...
    if (action === "linkDoc") {
        const { appointmentId, docId } = body;
        const appointment = store.appointments.find((appt)=>appt.id === appointmentId);
        if (appointment) {
            appointment.linkedDocs = Array.from(new Set([
                ...appointment.linkedDocs ?? [],
                docId
            ]));
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$household$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setHouseholdStore"])(store);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(appointment);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__adc28a10._.js.map