...
"[project]/.next-internal/server/app/api/household/members/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/household/members/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(store.members);
}
async function POST(request) {
    ...
    if (action === "role") {
        const { memberId, roleLabel } = body;
        store.members = store.members.map((member)=>member.id === memberId ? {
                ...member,
                roleLabel: roleLabel
            } : member);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$household$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setHouseholdStore"])(store);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b8665c0d._.js.map