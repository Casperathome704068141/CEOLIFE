...
function Header() {
    ...
    const { displayName, email, initials, photoURL } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        const fallbackEmail = "crew@ceolife.app";
        const candidateName = user?.displayName ?? user?.email ?? "Mission Specialist";
        const derivedInitials = candidateName.split(" ").map((part)=>part.charAt(0)).join("").slice(0, 2).toUpperCase();
        return {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$auth$2f$auth$2d$gate$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/auth/auth-gate.tsx [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function AppLayout({ children }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$auth$2f$auth$2d$gate$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AuthGate"], {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ff42eae5._.js.map