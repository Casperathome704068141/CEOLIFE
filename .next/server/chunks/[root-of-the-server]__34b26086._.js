...
"[project]/.next-internal/server/app/api/household/assets/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/household/assets/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
async function GET() {
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$household$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getHouseholdStore"])().assets);
}
async function POST(request) {
    ...
    if (action === "create") {
        ...
        const asset = {
            id: payload.id ?? (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["randomUUID"])(),
            name: payload.name,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(asset, {
            status: index >= 0 ? 200 : 201
        });
    }
    if (action === "warranty") {
        const { assetId, warrantyEnd } = body;
    ...
    if (action === "receipt") {
        const { assetId, receiptDocId } = body;
        const asset = store.assets.find((item)=>item.id === assetId);
        if (!asset) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Asset not found"
...
//# sourceMappingURL=%5Broot-of-the-server%5D__34b26086._.js.map