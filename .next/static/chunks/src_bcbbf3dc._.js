                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: items.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            ...
                            columnNumber: 13
                                ...
                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("group flex items-center gap-2 rounded-full border border-border/60 bg-background/80 px-3 py-1 text-xs shadow-sm transition cursor-pointer", "hover:border-primary/40 hover:text-primary"),
                                children: [
...
"[project]/src/app/(app)/pulse/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function PulsePage() {
    ...
    const { selectedLeagues, dateRange, onlyWatchlist } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$pulse$2f$usePreferences$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePreferences"])();
    const { items: watchlist, ids: watchlistIds, add: addToWatchlist } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$pulse$2f$useWatchlist$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWatchlist"])();
    ...
    const [alertContext, setAlertContext] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [explainContext, setExplainContext] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const dateFilters = {
        today: {
            ...
            to: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfDay$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startOfDay"])(new Date())
        },
        '7d': {
            from: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfDay$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startOfDay"])(new Date()),
        ...
        '30d': {
            from: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfDay$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startOfDay"])(new Date()),
            to: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$addDays$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDays"])(new Date(), 30)
        }
    };
    const { from, to } = dateFilters[dateRange];
    const leagues = selectedLeagues.join(',');
    const gamesQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'pulse',
            'games',
            leagues,
        ...
        queryFn: {
            "PulsePage.useQuery[gamesQuery]": ()=>fetch(`/api/pulse/sports?leagues=${leagues}&from=${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$formatISO$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatISO"])(from)}&to=${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$formatISO$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatISO"])(to)}`).then({
                    "PulsePage.useQuery[gamesQuery]": (res)=>res.json()
                }["PulsePage.useQuery[gamesQuery]"])
        }["PulsePage.useQuery[gamesQuery]"]
    });
    const oddsQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "PulsePage.useQuery[oddsQuery]": ()=>fetch(`/api/pulse/odds?leagues=${leagues}`).then({
                    "PulsePage.useQuery[oddsQuery]": (res)=>res.json()
    ...
    const insightsQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "PulsePage.useQuery[insightsQuery]": ()=>fetch(`/api/pulse/insights?leagues=${leagues}`).then({
                    "PulsePage.useQuery[insightsQuery]": (res)=>res.json()
    ...
    const weatherQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "PulsePage.useQuery[weatherQuery]": ()=>{
                const cities = Array.from(new Set(gamesQuery.data?.games.map({
                    "PulsePage.useQuery[weatherQuery].cities": (g)=>g.venueCity
                }["PulsePage.useQuery[weatherQuery].cities"]).filter(Boolean)));
                return fetch(`/api/pulse/weather?cities=${cities.join(',')}`).then({
                    "PulsePage.useQuery[weatherQuery]": (res)=>res.json()
                }["PulsePage.useQuery[weatherQuery]"]);
            }
        }["PulsePage.useQuery[weatherQuery]"],
        enabled: !!gamesQuery.data?.games.length
    });
    const prefsQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'pulse',
            'preferences'
        ],
        queryFn: {
            "PulsePage.useQuery[prefsQuery]": ()=>fetch('/api/pulse/preferences').then({
                    "PulsePage.useQuery[prefsQuery]": (res)=>res.json()
                }["PulsePage.useQuery[prefsQuery]"])
        }["PulsePage.useQuery[prefsQuery]"]
    });
...
_s(PulsePage, "iHlbrZhd8UoLt62JIesrMr7ErvY=", false, function() {
    return [
...
//# sourceMappingURL=src_bcbbf3dc._.js.map