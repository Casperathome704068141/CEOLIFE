...
"[project]/src/app/(app)/vault/documents/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function DocumentsPage() {
    ...
    const [activeDoc, setActiveDoc] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const bulkContext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DocumentsPage.useMemo[bulkContext]": ()=>{
            if (selected.length === 0) return null;
            return {
                ids: selected,
                doc: filteredDocs.find({
                    "DocumentsPage.useMemo[bulkContext]": (d)=>d.id === selected[0]
                }["DocumentsPage.useMemo[bulkContext]"])
            };
        }
    }["DocumentsPage.useMemo[bulkContext]"], [
...
_s(DocumentsPage, "t+rVW5dcF39DuKsZyZH1tMXE9tw=", false, function() {
    return [
...
//# sourceMappingURL=src_969056ab._.js.map