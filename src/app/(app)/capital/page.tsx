...
export default async function CapitalPage() {
  ...
  return (
    <div className="flex h-[calc(100vh-4rem)] w-full flex-col bg-[#050505] text-slate-100 overflow-hidden font-mono">
      ...
      <header className="flex h-12 shrink-0 items-center justify-between border-b border-slate-800 bg-slate-950 px-4 select-none">
        ...
        <div className="flex items-center gap-6">
           ...
           <div className="flex gap-6 text-[10px] font-medium">
              ...
              <span className="text-white font-mono text-xs tracking-wide">${(data.assets.reduce((acc, asset) => acc + (asset.balance * asset.price), 0)).toLocaleString()}</span>
